...
source(here::here(paths$r[[params$cycle]], "methodchapter_functions.R"))
source(here::here(paths$r[[params$cycle]], "methodchapter_tables.R"))
source(here::here(paths$r[[params$cycle]], "methodchapter_maps.R"))
source(here::here(paths$r[[params$cycle]], "methodchapter_inlines.R"))
# options(OutDec= ",") # Må stå etter konstruksjon av tabeller pga mystisk bug
```
...
For å gi et bilde av gruppen *ikke godkjent -- noen svar* viser @tbl-tbl2_3 maksimalt antall svar for hver respondentgruppe, samt gjennomsnitt og median for både ekskluderte og inkluderte respondenter.
...
Endelig svarprosent relatert til bruttoutvalg og populasjon er vist i @tbl-tbl2_4. Populasjonstallene for grunnskoler, videregående skoler og kommuner er hentet fra Nasjonalt skoleregister (NSR).
...
Fra en populasjon på 2 656 ordinære grunnskoler ble 881 invitert til å besvare undersøkelsen. Av disse gjennomførte 357 hele undersøkelsen, mens 113 besvarte deler av den. Av de som delvis besvarte undersøkelsen hadde 28 nok svar til å bli inkludert. Dermed blir det totale antallet grunnskoler i undersøkelsen 385. Det er 408 som ikke har åpnet eller svart på undersøkelsen, mens 3 skoleledere aktivt ga beskjed om at de ikke ønsket å delta.
...
#| label: fig-fig2_2
ggiraph::girafe(ggobj = fig_2.2)
```

I @tbl-tbl2_6 og @tbl-tbl2_7 vises svarprosent for grunnskolene sortert på henholdsvis landsdel og skoletype, og landsdel og skolestørrelse. @tbl-tbl2_6 viser at svarprosenten totalt sett er relativ lik mellom barneskoler, 1--10-skoler og Ungdomsskoler. Når det gjelder landsdel totalt er svarprosenten høyest blant skolene lokalisert i Oslo-området, fulgt av Sør- og Vest-Norge og Øst-Norge. Svarprosenten er klart lavere i Midt- og Nord-Norge.
...
@tbl-tbl2_8 og @tbl-tbl2_9 viser hvordan nettoutvalget, altså de grunnskolene som har deltatt i undersøkelsen, er sammensatt etter landsdel, skoletype og skolestørrelse, sammenliknet med populasjonen av grunnskoler.
...
Når det gjelder skolestørrelse viser @tbl-tbl2_9 at deltakelsen er svært nære det vi finner i populasjonen. Det største avviket vi finner er for skoler med mindre enn 100 elever, som har en overrepresentasjon på 1,8 prosentpoeng.

@tbl-tbl2_10 indikerer at fordelingen i nettoutvalget mellom offentlig og privat eierskap og målform korresponderer godt med fordelingen i populasjonen.
...
@tbl-tbl2_11 oppsummerer populasjonen og utvalget sortert på fylke samt hvilken svarprosent som ble oppnådd.
...
@tbl-tbl2_13 viser at det er små avvik mellom utvalg og populasjon når det gjelder skolestørrelse. Skolene med mellom 250 og 599 elever er svakt overrepresentert, mens skolene med mer enn 600 elever svakt underrepresentert. Ser vi innad i landsdelene er imidlertid ikke avvikene særlig store.
...
@tbl-tbl2_14 indikerer at fordelingen i nettoutvalget når det gjelder offentlig og privat eierskap korresponderer ganske godt med fordelingen i populasjonen. Vi ser en svak overrepresentasjon av offentlige skoler, og en svak underrepresentasjon av private skoler, i utvalget sammenliknet med populasjonen. Når det gjelder målform finner vi relativt små forskjeller.
...
Liknende spørsmål ble stilt til skoleeierne. I @tbl-tbl2_19 vises hvem som svarer på undersøkelsen på vegne av skoleeierne i (fylkes)kommunen. I kommunene er det først og fremst skolefaglig ansvarlige som har besvart undersøkelsen, mens oppgaven i større grad har blitt utført av seksjonsleder/avdelingsleder i fylkeskommunene. Vi ser at summen av de som har svart overstiger antallet skoleeiere som er med, noe som betyr at mer enn én person er involvert.
